					...
					<div class="toolbar row">
						<div class="col-sm-6 hidden-xs">
							<div class="page-header">
								<h1>Personal <small>Se Modificaran y guardaran los datos del personal que trabaja en la empresa</small></h1>
							</div>
						</div>
							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<h2><i class="fa fa-pencil-square"></i> Modificar</h2>
										<p>Modificar Empleado</p>
										<?php  foreach ($personalm as $value) {?>
										<form role="form" id="form" method="post" action="<?php echo base_url()?>Personal_c/actualizar_empleado">
											<div class="col-md-12">
											...
											<div class="col-md-6">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="text" maxlength="30" value="<?php echo $value->apellido_materno;?>" placeholder="Insertar Apellido Materno" class="form-control" id="materno" name="materno">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
															...
															<input type="text" maxlength="30" value="<?php echo $value->apellido_paterno;?>" placeholder="Insertar Apellido Materno" class="form-control" id="paterno" name="paterno">
															</div>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="text" maxlength="6"  value="<?php echo $value->telefono;?>" placeholder="" class="form-control" id="fijo" name="fijo">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
															...
															<input type="text" value="<?php echo $value->celular;?>" maxlength="9" placeholder="" class="form-control" id="celular" name="celular">
															</div>
														</div>
													</div>
													<div class="form-group">
														...
														<input type="text" maxlength="30" value="<?php echo $value->direccion;?>" placeholder="Direccion" class="form-control" id="direccion" name="direccion">
													</div>
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
													...
													<div class="form-group connected-group">
														...
														<div class="input-group">
															<input type="text" data-date-format="dd-mm-yyyy" value="<?php  echo $value->fecha_nacimiento;?>" 
															name="fecha" id="fecha" data-date-viewmode="years" class="form-control date-picker">
													...
													<div class="form-group">
														...
														<div>
															...
															<label class="radio-inline">
																...
																<input type="radio" class="grey" value="<?php echo $values->id_sexo; ?>" name="sexo" id="<?php echo $values->id_sexo; ?>" checked>
																<?php echo $values->descripcion; ?>
															</label>
															<?php }else{ ?>
															<label class="radio-inline">
																
																<input type="radio" class="grey" value="<?php echo $values->id_sexo; ?>" name="sexo" id="<?php echo $values->id_sexo; ?>" >
																<?php echo $values->descripcion; ?>
															</label>
															<?php
															}
													...
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
																...
																<option value="<?php echo $value->id_tipodocumento;?>"><?php echo $value->dni;?></option>
																<?php foreach ($tipo_doc as $values ) { ?>
																	<option value="<?php echo $values->id_tipodocumento;?>"><?php echo $values->descripcion; ?></option>
																<?php } ?>
																</select>
																</div>
															</div>
														...
														<div class="col-md-8">
															<div class="form-group">
																...
																<input class="form-control tooltips" value="<?php echo $value->nro_documento;?>" type="number" maxlength="15" data-original-title="Insertar el número de su documento" data-rel="tooltip"  title="" data-placement="top" name="documento" id="documento">
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="number" placeholder="" value="<?php echo $value->numero_hijo;?>" class="form-control" id="hijos" name="hijos">
															</div>
														</div>
														<div class="col-md-8">
															<div class="form-group">
																...
																<input class="form-control tooltips" value="<?php echo $value->hobby;?>" maxlength="20" type="text"  type="text" data-placement="top" name="hobby" id="hobby">
															</div>
														</div>
													</div>
													<div class="form-group">
																...
																<select class="form-control" id="tipo_empleado" name="tipo_empleado">
																	<option value="<?php echo $value->id_perfil_usuario;?>"><?php echo $value->tipo_perfil;?></option>
																<?php foreach ($tipo_empleado as $values ) { ?>
																	<option value="<?php echo $values->id_perfil_usuario;?>"><?php echo $values->descripcion; ?></option>
																<?php } ?>
																</select>
																</div>
													</div>
													...
													<div class="row">
														<div class="col-md-3">
															<p>
															<a href="#" id="cancelar" class="btn btn-red btn-block" type="">
																 <i class="fa fa-arrow-circle-left"></i> Cancelar
															</a>
															</p>
														</div>
														<div class="col-md-3">
															<button id="actualizar" class="btn btn-yellow btn-block" type="submit">
...
var runValidator1 = function () {
        ...
        }, 'Por favor seleccione un año, un mes y día de nacimiento!');
